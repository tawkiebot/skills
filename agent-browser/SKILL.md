...
Use `eval` to run JavaScript. For complex expressions, use `--stdin` or `-b` (base64):
...
# Or base64
agent-browser eval -b "$(echo 'expression' | base64)"
```

## Resources

- Full docs: https://github.com/anomalyco/agent-browser
- Installation: `npm install -g @anomalyco/agent-browser`
